-- CONFIG
APP_NAME = "Dragon Ball Legacy"  -- important, change it, it's name for config dir and files in appdata
...
Servers = {
  DragonBallLegacy = "dblegacy.pl:7171:800",
}
ALLOW_CUSTOM_SERVERS = false -- if true it shows option ANOTHER on server list
g_app.setName("Dragon Ball Legacy")
-- CONFIG END
